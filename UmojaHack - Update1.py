...
def extract():
    ...
    #new_features = pd.DataFrame.from_dict(features, orient = '')
    #features_items = features.items()
    #features_list = list(features_items)
    #new_features = pd.DataFrame(features_list) #index = range(len(new_features)))
    print(features)
    #print(new_features)
